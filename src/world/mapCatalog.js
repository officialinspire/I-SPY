...
export const MAP_CATALOG = Object.freeze([
  Object.freeze({
    ...
    difficulty: 1,
    conditions: Object.freeze(['CLEAR', 'RAIN', 'SNOW']),
  ...
  Object.freeze({
    ...
    difficulty: 2,
    conditions: Object.freeze(['CLEAR', 'SNOW']),
    recommendedZoom: 0.75,
  ...
  Object.freeze({
    ...
    difficulty: 3,
    conditions: Object.freeze(['CLEAR', 'RAIN']),
    recommendedZoom: 0.75,
  ...
  Object.freeze({
    id: 'dustline-sector',
    title: 'DUSTLINE SECTOR',
    environment: 'ARID FRONTIER',
    description: 'Open desert crossed by a military service road and dry wadi, with rocky concealment, scattered ruins, a checkpoint and a fortified fuel-and-radar outpost.',
    difficulty: 3,
    conditions: Object.freeze(['CLEAR']),
    recommendedZoom: 0.72,
    source: 'assets/maps/dustline-sector.json',
  }),
  Object.freeze({
